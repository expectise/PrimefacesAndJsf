...
import com.serpienteemplumada.views.beans.ProductshomeViewBean;


@Scope("view")
@Component("productshome")
public class ProductshomeView extends ProductshomeViewBean{
	...
	public void init() {
		...
		if (req.getParameter("id") != null) {
			...
			setIdProducts(Long.parseLong(id));
		}
